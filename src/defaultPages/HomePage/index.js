  ...
  render() {
    ...
    return (
      <div css={wrapperStyle()}>
        {authRedirect}
        <p css={titleStyle()}>You're all set</p>
        <p css={subTitleStyle()}>Discover your curated community now</p>
        <div css={UIComponentStyle()}>
          <div css={boxStyle()}>
            <div css={titleWrapperStyle()}>
              <div css={thumbnailWrapperStyle}><img src={listComponent} alt="Group List" /></div>
              <h2 css={componentTitleStyle()}>Community</h2>
            </div>
            <ul css={linkWrapperStyle()}>
              <li><Link css={linkStyle()} to="/groups">Enter</Link></li>
            </ul>
          </div>
        </div>
        <div css={UIComponentStyle()}>
